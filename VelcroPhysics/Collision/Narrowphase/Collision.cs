...
namespace VelcroPhysics.Collision.Narrowphase
{
    ...
    public static class Collision
    {
        ...
        public static bool TestOverlap(Shape shapeA, int indexA, Shape shapeB, int indexB, ref Transform xfA, ref Transform xfB)
        {
            ...
            return output.Distance < new Fix64(10) * Fix64.Epsilon;
        }
        ...
        /// <returns></returns>
        internal static int ClipSegmentToLine(out FixedArray2<ClipVertex> vOut, ref FixedArray2<ClipVertex> vIn, Vec2 normal, Fix64 offset, int vertexIndexA)
        {
            ...
            Fix64 distance0 = Vec2.Dot(normal, vIn.Value0.V) - offset;
            Fix64 distance1 = Vec2.Dot(normal, vIn.Value1.V) - offset;
