...
namespace VelcroPhysics.Collision.Shapes
{
    ...
    public class EdgeShape : Shape
    {
        ...
        public EdgeShape(Vec2 start, Vec2 end) : base(ShapeType.Edge, Settings.PolygonRadius)
        {
            Set(start, end);
            ComputeProperties();
        }
        ...
        /// </summary>
        public Vec2 Vertex0 { get; set; }

        /// <summary>
        /// Optional adjacent vertices. These are used for smooth collision.
        /// </summary>
        public Vec2 Vertex3 { get; set; }
        ...
        {
            MassData.Centroid = Fix64.Half * (_vertex1 + _vertex2);
        }
