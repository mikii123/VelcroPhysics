...
namespace VelcroPhysics.Collision.Shapes
{
    ...
    public class CircleShape : Shape
    {
        ...
        internal CircleShape() : base(ShapeType.Circle, Fix64.Zero, Fix64.Zero) { }
        ...
        private void ComputeInertia()
        {
            ...
            MassData.Inertia = MassData.Mass * (Fix64.Half * _2radius + Vec2.Dot(Position, Position));
        }
