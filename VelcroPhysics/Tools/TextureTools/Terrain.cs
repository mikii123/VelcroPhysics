...
namespace VelcroPhysics.Tools.TextureTools
{
    ...
    public class Terrain
    {
        ...
        public Terrain(World world, Vec2 position, Fix64 width, Fix64 height)
        {
            World = world;
            Width = width;
            Height = height;
        ...
        public void Initialize()
        {
            ...
            _topLeft = new Vec2(Center.X - (Width * Fix64.Half), Center.Y - (-Height * Fix64.Half));
            ...
            _dirtyArea = new AABB(new Vec2(Fix64.MaxValue, Fix64.MaxValue), new Vec2(Fix64.MinValue, Fix64.MinValue));
        }
        ...
        private void GenerateTerrain(int gx, int gy)
        {
            ...
            List<Vertices> polys = MarchingSquares.DetectSquares(new AABB(new Vec2(ax, ay), new Vec2(ax + CellSize, ay + CellSize)), new Fix64(SubCellSize), new Fix64(SubCellSize), _terrainMap, Iterations, true);
            if (polys.Count == 0)
                return;
