...
namespace FixedMath.Net
{
    ...
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>
    {
        ...
        public static readonly Fix64 Epsilon = Fix64.One / new Fix64(100);
        public static readonly Fix64 EpsilonSmaller = Fix64.One / new Fix64(200);
        public static readonly Fix64 Zero = new Fix64();
        public static readonly Fix64 One = new Fix64(ONE);
        public static readonly Fix64 Two = Fix64.One + Fix64.One;
        public static readonly Fix64 Half = Fix64.One / Fix64.Two;
        public static readonly Fix64 Three = Fix64.Two + Fix64.One;
        public static readonly Fix64 Four = Fix64.Three + Fix64.One;
        public static readonly Fix64 Five = Fix64.Four + Fix64.One;
		...
		public static Fix64 SignF(Fix64 value)
		{
			return
        ...
        public static Fix64 operator*(int y, Fix64 x)
        {
	        return x * new Fix64(y);
        }
        ...
        {
	        return x.m_rawValue == new Fix64(y).m_rawValue;
        }

        public static bool operator==(int x, Fix64 y)
        {
	        return new Fix64(x).m_rawValue == y.m_rawValue;
        }
		...
		public static Fix64 MoveTowards(Fix64 current, Fix64 target, Fix64 maxDelta)
		{
			...
			return current + (Fix64)Sign(target - current) * maxDelta;
		}
		...
		{
			var delta = Repeat(target - current, (Fix64)360);
			if (delta > (Fix64)180)
			{
				delta -= (Fix64)360;
			}
		...
		{
			return (t - Floor(t / length) * length).Clamp(Zero, length);
		}
		...
		public static explicit operator Fix64(string str)
		{
			string[] parts = str.Split('/');

			switch (parts.Length)
			{
				case 1:  return (Fix64)int.Parse(parts[0]);
				case 2:  return (Fix64)int.Parse(parts[0]) / (Fix64)int.Parse(parts[1]);
				default: return Zero;
			}
		}
